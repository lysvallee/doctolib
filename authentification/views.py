...
def alimentationPatients():
    listePatients = pd.read_csv("/home/ev/greta/web/django/django-simplon/doctolibbydjango/authentification/datas/listePatients.csv")
...
def alimentationMedecin():
    listeMedecins = pd.read_csv("/home/ev/greta/web/django/django-simplon/doctolibbydjango/authentification/datas/listeMedecins.csv")
